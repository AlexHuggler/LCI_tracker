...
faq:
  - question: "What PPE do pool technicians need?"
    answer: "Pool technicians should wear chemical-resistant gloves (nitrile or neoprene), splash-proof safety goggles or a face shield, and closed-toe shoes when handling pool chemicals. When working with concentrated chemicals, particularly granular chlorine products or muriatic acid, a NIOSH-approved respirator with acid gas cartridges is recommended. Long sleeves and chemical-resistant aprons provide additional protection against splashes. The specific PPE requirements depend on the chemicals being handled, and the Safety Data Sheet for each product specifies the recommended protective equipment."
  - question: "Can I mix pool chemicals?"
    answer: "No, you should never directly mix pool chemicals together. Combining different pool chemicals, particularly chlorine-based products and acid-based products, can cause violent reactions that produce toxic gases, explosions, or fires. Calcium hypochlorite and trichlor should never be mixed, as this combination can cause spontaneous combustion. Chlorine products and muriatic acid must never be combined, as this produces deadly chlorine gas. Each chemical should be added separately to the pool water with adequate time between additions for proper dilution and circulation. Always add chemicals to water, never water to chemicals, and never add different chemicals through the same feeder or container."
---
...
For information on maintaining compliance with other regulatory bodies, see our guides on [health department pool compliance](/blog/health-department-pool-compliance/) and [EPA water treatment regulations](/blog/epa-water-treatment-regulations-pools/).
