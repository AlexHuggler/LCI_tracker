...
faq:
  - question: "How should pool chemicals be stored on a truck?"
    answer: "Pool chemicals on a service truck must be stored in separate, sealed compartments to prevent cross-contamination. Oxidizers like chlorine tablets must be physically separated from acids like muriatic acid, ideally in DOT-approved containers secured against shifting during transport. Maintain proper ventilation, keep Safety Data Sheets accessible, and never exceed the weight limits specified by DOT regulations for your vehicle class."
  - question: "Can I store muriatic acid next to chlorine?"
...
For a deeper understanding of the chemical interactions at play, see our guide on [pool water balance and chemistry](/blog/pool-water-balance-chemistry-guide/) which explains how these chemicals behave when properly diluted in pool water versus their concentrated storage forms.
