...
executive_summary: |
  Cyanuric acid (CYA) is the invisible backbone of outdoor pool sanitation, shielding chlorine from ultraviolet degradation. Yet too much of it renders chlorine ineffective, creating a condition many technicians call chlorine lock. This article explains what CYA does at the molecular level, why the ideal range sits between 30 and 50 ppm, and how stabilized chlorine products like dichlor and trichlor steadily push CYA higher with every dose. We cover the critical CYA-to-chlorine ratio, how elevated CYA distorts alkalinity readings and LSI calculations through the adjusted alkalinity formula, and why partial draining remains the only reliable method for reducing CYA concentration. Service professionals will walk away with a clear protocol for diagnosing, communicating, and correcting high-CYA situations.
faq:
  - question: "What happens if CYA is too high?"
    answer: "When CYA exceeds 80-100 ppm, it binds so much free chlorine that the remaining active chlorine (hypochlorous acid) cannot effectively sanitize the water. Algae blooms become persistent, combined chlorine rises, and the pool may appear hazy even with a seemingly adequate free chlorine reading. The only practical remedy is to partially drain and refill the pool with fresh water to dilute the CYA concentration back into the 30-50 ppm target range."
  - question: "How do I lower CYA without draining the pool?"
...
1. **Test CYA accurately** using a turbidity-based test (melamine reagent) rather than test strips.
2. **Calculate the drain percentage:** 1 - (Target CYA / Current CYA). For 120 down to 40: 1 - (40/120) = 67 percent.
3. **Drain in stages.** No more than one-third at a time to protect the shell.
4. **Refill and circulate** for at least two hours before retesting.
5. **Rebalance all chemistry.** Fresh fill water changes pH, alkalinity, calcium hardness, and chlorine levels. Review your [seasonal maintenance checklist](/blog/seasonal-pool-maintenance-checklist/) for comprehensive rebalancing guidance.
...
**Ignoring CYA in LSI calculations.** Failing to use the adjusted alkalinity formula leads to inaccurate balance assessments. This is especially problematic for [pool service profitability](/blog/pool-service-profitability-guide/) because surface damage from corrosive water results in costly callbacks.
