...
faq:
  ...
  - question: "What should I cover during new customer onboarding?"
    answer: "The first visit should include a thorough inspection of the pool, equipment, and chemistry baseline, along with a clear conversation about service scope. Cover what your weekly visit includes and excludes, expected visit day and approximate time window, the customer's responsibilities between visits such as emptying skimmer baskets and running the pump, factors that affect water quality beyond your control, how to contact you for issues between visits, and your callback and response time policy. Document the pool's current condition with photos and chemical readings as a baseline. This protects both parties if disputes arise later about pre-existing conditions."
---
