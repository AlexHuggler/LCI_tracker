...
faq:
  - question: "How much should I charge for pool service?"
    answer: "Residential weekly pool service typically ranges from eighty to one hundred seventy-five dollars per month, depending on your market, pool size, service scope, and whether chemicals are included. To find your specific rate, calculate your total monthly costs per pool (chemicals, fuel, insurance, supplies, and your target hourly wage for time on site and driving), then add your desired profit margin. Most successful operators target a minimum of fifty to sixty percent gross margin after chemical costs, which means if you spend forty dollars per month in chemicals on a pool, your minimum price should be around one hundred thirty-five dollars."
  - question: "When should I raise pool service prices?"
...
1. **The pool has a chemistry problem** that is driving excessive chemical consumption. High CYA requiring constant over-chlorination, a persistent pH drift from a plaster issue, or a phosphate source that feeds recurring algae. Diagnose and address the root cause. Our guide on [CYA management](/blog/cya-cyanuric-acid-management/) covers one of the most common culprits.

2. **The pool is larger or more complex than your pricing reflects.** Reassess the account and adjust the price to match the actual cost of service.

3. **You are over-dosing chemicals.** This is a technique issue. Review your [dosing calculations](/blog/chemical-dosing-calculations-pool-service/) and verify that you are applying the correct amounts based on pool volume and current readings rather than estimating.
...
When a customer pushes back on a price increase, respond with data. Show them the chemical cost trend for their pool. Explain how fuel costs have changed. Reference the [seasonal maintenance](/blog/seasonal-pool-maintenance-checklist/) scope that they receive. Most pushback dissolves when the customer understands the actual costs behind the service.
...
This review process turns pricing from an emotional decision into a data-driven one. The more data you collect on chemical costs, time per stop, and revenue per account, the better your pricing decisions become. See our detailed guide on [pool service profitability](/blog/pool-service-profitability-guide/) for a deeper dive into the financial metrics that matter.
