...
executive_summary: |
  The Environmental Protection Agency (EPA) plays a significant regulatory role in the swimming pool industry through its oversight of disinfectant registration, water quality standards, and environmental disposal requirements. All pool disinfectants sold in the United States must be registered with the EPA under the Federal Insecticide, Fungicide, and Rodenticide Act (FIFRA), ensuring that products meet efficacy and safety standards before reaching the market. Pool operators must use these chemicals in accordance with their EPA-registered label instructions. Disinfection byproducts such as trihalomethanes and chloramines, formed when disinfectants react with organic matter, are regulated under the Safe Drinking Water Act and inform best practices for pool water management. Cyanuric acid (CYA) limits, while enforced primarily by state and local health departments, are grounded in research supported by EPA water quality principles. Proper disposal of pool chemicals and chemically treated water is subject to EPA environmental regulations that prevent contamination of waterways and ecosystems.
faq:
  - question: "Does the EPA regulate pool chemicals?"
    answer: "Yes, the EPA regulates pool chemicals in several important ways. All disinfectants and sanitizers used in swimming pools must be registered with the EPA under the Federal Insecticide, Fungicide, and Rodenticide Act (FIFRA). This registration process requires manufacturers to demonstrate that their products are effective and safe when used as directed. The EPA assigns a registration number to each approved product, which must appear on the product label. Pool operators are legally required to use these products in accordance with the label instructions. Additionally, the EPA regulates the environmental disposal of pool chemicals and chemically treated water through the Clean Water Act and the Resource Conservation and Recovery Act."
  - question: "What is the CYA limit for pools?"
    answer: "Cyanuric acid (CYA) limits for swimming pools are set primarily by state and local health departments rather than directly by the EPA. However, the most widely adopted standards recommend a maximum CYA level of 100 ppm for standard chlorinated pools. The CDC Model Aquatic Health Code recommends a maximum of 90 ppm. Some jurisdictions have adopted lower limits of 70 or 80 ppm based on research showing that elevated CYA levels significantly reduce chlorine's disinfecting effectiveness. For saltwater chlorine generator pools, some manufacturers recommend CYA levels between 60 and 80 ppm. The key concern is that as CYA increases, the ratio of free chlorine to CYA must also increase to maintain adequate disinfection, making water management progressively more difficult at higher CYA concentrations."
---
...
Understanding [CPO certification exam topics](/blog/cpo-certification-guide/) provides additional technical depth on the relationship between CYA, chlorine effectiveness, and water balance management.
...
Maintaining awareness of [OSHA chemical handling requirements](/blog/osha-chemical-handling-pool-technicians/) alongside EPA regulations ensures that pool service companies address the full spectrum of federal regulatory obligations related to chemical management.

State and local regulations often incorporate or exceed EPA standards, making it important to understand both federal requirements and the specific rules in your operating jurisdiction. Our guide on [state pool service licensing requirements](/blog/state-pool-service-licensing-requirements/) covers the broader regulatory landscape for pool professionals.
